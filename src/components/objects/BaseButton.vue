...
export default defineComponent({
  ...
  setup (props: Props) {
    ...
    if (props.textStyle) {
      ...
      style = 'ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-yellow-300 rounded-md shadow-sm text-base font-medium text-yellow-300 hover:bg-yellow-50'
    }
